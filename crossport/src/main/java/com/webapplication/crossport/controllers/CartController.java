...
public class CartController
{
    ...
    // TODO DPO - Ralalal RES est si loin déjà.
    //  Si vous modifiez le panier, il vaut mieux faire un PATCH ou PUT qu'un GET, non ?
    //  Je vous laisse vérifier les autres endpoints également
